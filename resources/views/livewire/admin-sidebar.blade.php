    ...
    <nav class="flex-1 py-6 px-4 space-y-1.5 overflow-y-auto">
        ...
        @hasanyrole('admin|superadmin')
            ...
            <a href="{{ route('admin.sell-phones.index') }}" wire:navigate
                class="flex items-center gap-3 px-4 py-3 rounded-2xl text-sm transition-colors cursor-pointer {{ request()->routeIs('admin.sell-phones.*') ? $activeClass : $inactiveClass }}">
        ...
        @hasanyrole('admin|super admin')
            ...
            <a href="{{ route('admin.settings.catalog') }}" wire:navigate
                class="flex items-center gap-3 px-4 py-3 rounded-2xl text-sm transition-colors cursor-pointer {{ request()->routeIs('admin.settings.catalog') ? $activeClass : $inactiveClass }}">
