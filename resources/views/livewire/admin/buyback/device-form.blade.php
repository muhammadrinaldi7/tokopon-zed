<div class="max-w-3xl mx-auto space-y-6">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        {{-- Card Header --}}
        <div class="bg-gradient-to-r from-[#4E44DB] to-[#7C74F0] px-6 py-5">
        ...
        <form wire:submit.prevent="save" class="p-6 space-y-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                    ...
                    <select wire:model="brand_id"
                        class="w-full rounded-xl border-gray-200 py-2.5 focus:ring-[#4E44DB] focus:border-[#4E44DB] text-sm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 items-start">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" wire:model.live="base_price" placeholder="0"
                            class="w-full rounded-xl border-gray-200 py-2.5 pl-10 focus:ring-[#4E44DB] focus:border-[#4E44DB] text-sm">
                    </div>
                ...
                <div class="pt-6">
                    ...
                    @else
                        <div class="flex items-center gap-3 p-4 bg-gray-50 border border-gray-200 rounded-xl text-gray-400">
            ...
            <div class="flex items-center gap-3 p-4 bg-gray-50 rounded-xl border border-gray-100">
                <input type="checkbox" wire:model="is_active" id="is_active"
                    class="h-4 w-4 text-[#4E44DB] border-gray-300 rounded focus:ring-[#4E44DB]">
                <div>
            ...
            <div class="pt-2 flex gap-3 border-t border-gray-100">
                <a href="{{ route('admin.buyback.index') }}" wire:navigate
                    class="flex-1 text-center px-4 py-2.5 rounded-xl font-bold text-gray-600 bg-gray-100 hover:bg-gray-200 transition">
                    Batal
                </a>
                <button type="submit"
                    class="flex-1 px-4 py-2.5 rounded-xl font-bold text-white bg-[#4E44DB] hover:bg-[#3f36b8] transition shadow-lg shadow-[#4E44DB]/30">
                    Simpan Perangkat
                </button>
            </div>
        </form>
