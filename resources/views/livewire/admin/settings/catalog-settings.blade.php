    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 max-w-3xl">
        <form wire:submit.prevent="save">
            ...
            <div class="mb-6 space-y-4">
                <div class="bg-[#eff2ff] p-4 rounded-xl border border-[#4E44DB]/20">
                    <p class="text-sm text-[#4E44DB] font-medium leading-relaxed">
                ...
                <div>
                    ...
                    <input type="number" wire:model="minimumStockThreshold" min="0" class="w-full text-[15px] rounded-xl border-gray-300 px-4 py-3 shadow-sm focus:ring-4 focus:ring-[#4E44DB]/10 focus:border-[#4E44DB] transition-all" placeholder="Contoh: 5">
            ...
            <div class="flex justify-end pt-5 border-t border-gray-50">
                <button type="submit" wire:loading.attr="disabled" class="bg-[#4E44DB] text-white px-8 py-3 rounded-xl font-bold hover:bg-[#3f36b8] active:scale-95 transition-all shadow-lg shadow-[#4E44DB]/25 disabled:opacity-50 flex items-center gap-2">
