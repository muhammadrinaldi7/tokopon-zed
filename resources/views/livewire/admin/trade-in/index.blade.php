                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse ($tradeIns as $item)
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4">
                                <div class="font-bold text-[#4E44DB]">{{ $item->old_phone_brand }} {{ $item->old_phone_model }}</div>
                            ...
                            <td class="px-6 py-4 text-right">
                                <a href="{{ route('admin.trade-ins.show', $item) }}" wire:navigate class="text-[#4E44DB] hover:text-[#3f36b8] font-semibold text-sm">
