                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 {{ $tradeIn->status === 'INSPECTING' ? 'mt-6 border-amber-200 bg-amber-50/30' : '' }}">
                    ...
                    <form>
                            ...
                            @forelse($availableVariants as $variant)
                                ...
                                <label class="block cursor-pointer">
                                    <div class="flex items-center gap-4 p-4 rounded-xl border-2 transition-all {{ $isSelected ? 'border-[#4E44DB] bg-[#4E44DB]/5' : 'border-gray-100 hover:border-gray-300' }}">
                                        <div class="w-5 h-5 rounded-full border {{ $isSelected ? 'bg-[#4E44DB] border-[#4E44DB]' : 'border-gray-300' }} flex items-center justify-center shrink-0">
                                            @if($isSelected)
                        ...
                        <div class="flex gap-4">
                            ...
                            <button type="button" wire:click="markAsPhysicallyVerified" wire:confirm="Sistem akan langsung menagih pembayaran sisa kepada Klien (jika ada selisih). Lanjutkan?" class="flex-1 px-6 py-3 rounded-lg font-bold bg-indigo-600 text-white hover:bg-indigo-700 shadow-md shadow-indigo-600/30 transition">
